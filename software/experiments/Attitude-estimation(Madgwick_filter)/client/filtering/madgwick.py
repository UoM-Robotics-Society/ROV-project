...
gyroMeasError = math.pi / 180. * 5.0

# gyroscope measurement error in rad / s / s
gyroMeasDrift = math.pi / 180. * 0.2

# beta from publication
beta = math.sqrt(3. / 4.) * gyroMeasError

# zeta from publication
zeta = math.sqrt(3. / 4.) * gyroMeasDrift
...
w_bx, w_by, w_bz = 0, 0, 0


def filterUpdate(w_x, w_y, w_z, a_x, a_y, a_z, m_x, m_y, m_z):
    ...
    SEq_2SEq_4 = SEq_2 * SEq_4
    h_x = twom_x * (0.5 - SEq_3 * SEq_3 - SEq_4 * SEq_4) + twom_y * (SEq_2SEq_3 - SEq_1SEq_4) + twom_z * (
                SEq_2SEq_4 + SEq_1SEq_3)
    h_y = twom_x * (SEq_2SEq_3 + SEq_1SEq_4) + twom_y * (0.5 - SEq_2 * SEq_2 - SEq_4 * SEq_4) + twom_z * (
                SEq_3SEq_4 - SEq_1SEq_2)
    h_z = twom_x * (SEq_2SEq_4 - SEq_1SEq_3) + twom_y * (SEq_3SEq_4 + SEq_1SEq_2) + twom_z * (
                0.5 - SEq_2 * SEq_2 - SEq_3 * SEq_3)
